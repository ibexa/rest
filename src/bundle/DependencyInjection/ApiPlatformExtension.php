...
//        }
    ...
    {
        $loader = new XmlFileLoader($container, new FileLocator(__DIR__.'/../Resources/config/api_platform'));

        $configuration = new ApiPlatformConfiguration();
...
//        $this->registerGraphQlConfiguration($container, $config, $loader);
        ...
        $container->setParameter('api_platform.graphql.graphiql.enabled', false);
        $container->setParameter('api_platform.graphql.graphql_playground.enabled', false);
