...
#[Delete(
    ...
    openapi: new Model\Operation(
        operationId: 'ibexa.rest.delete_object_state',
        ...
        responses: [
            Response::HTTP_NO_CONTENT => new Model\Response(description: 'No Content - Object state deleted.'),
            Response::HTTP_UNAUTHORIZED => new Model\Response(description: 'Error - The user is not authorized to delete an Object state.'),
...
class ObjectStateDeleteController extends RestController
{
     ...
     */
    public function deleteObjectState(int $objectStateId): Values\NoContent
    {
