...
#[Patch(
    ...
    openapi: new Model\Operation(
        ...
        responses: [
            ...
            Response::HTTP_UNAUTHORIZED => new Model\Response(description: 'Error - The user is not authorized to update an Object state group.'),
            Response::HTTP_FORBIDDEN => new Model\Response(description: 'Error - An Object state group with the provided identifier already exists.'),
