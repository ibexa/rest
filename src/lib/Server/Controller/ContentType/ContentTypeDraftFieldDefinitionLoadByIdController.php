...
#[Get(
    ...
    openapi: new Model\Operation(
        ...
        responses: [
            ...
            Response::HTTP_UNAUTHORIZED => new Model\Response(description: 'Error - The user is not authorized to read the content type draft.'),
            Response::HTTP_NOT_FOUND => new Model\Response(description: 'Error - The content type or draft does not exist.'),
        ],
    ),
)]
