...
#[Post(
    ...
    openapi: new Model\Operation(
        ...
        responses: [
            ...
            Response::HTTP_UNAUTHORIZED => new Model\Response(description: 'Error - The user is not authorized to create the draft.'),
            Response::HTTP_FORBIDDEN => new Model\Response(description: 'Error - A content type with the given new identifier already exists. A draft already exists.'),
        ],
    ),
)]
