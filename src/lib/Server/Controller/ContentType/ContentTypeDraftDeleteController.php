...
#[Delete(
    ...
    openapi: new Model\Operation(
        ...
        responses: [
            Response::HTTP_NO_CONTENT => new Model\Response(description: 'No Content - content type draft deleted.'),
            Response::HTTP_UNAUTHORIZED => new Model\Response(description: 'Error - The user is not authorized to delete this content type draft.'),
