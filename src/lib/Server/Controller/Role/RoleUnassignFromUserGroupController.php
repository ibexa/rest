...
#[Delete(
    ...
    openapi: new Model\Operation(
        operationId: 'ibexa.rest.unassign_role_from_user_group',
            ...
            Response::HTTP_OK => new Model\Response(
                ...
                content: new ArrayObject([
                    'application/vnd.ibexa.api.RoleAssignmentList+json' => [
                        ...
                        'x-ibexa-example-file' => '@IbexaRestBundle/Resources/api_platform/examples/user/groups/path/roles/role_id/DELETE/RoleAssignmentList.json.example',
                    ],
                    'application/vnd.ibexa.api.RoleAssignmentList+xml' => [
                        'schema' => [
                            '$ref' => '#/components/schemas/RoleAssignmentList',
                        ],
                        'x-ibexa-example-file' => '@IbexaRestBundle/Resources/api_platform/examples/user/groups/path/roles/role_id/DELETE/RoleAssignmentList.xml.example',
                    ],
                ]),
            ),
            Response::HTTP_UNAUTHORIZED => new Model\Response(description: 'Error - the user is not authorized to delete this Role assignment.'),
        ],
    ),
)]
