...
#[Delete(
    ...
    openapi: new Model\Operation(
        ...
        responses: [
            Response::HTTP_NO_CONTENT => new Model\Response(description: 'No Content - deleted a Relation of the given draft.'),
            Response::HTTP_UNAUTHORIZED => new Model\Response(description: 'Error - the user is not authorized to delete this Relation.'),
            Response::HTTP_FORBIDDEN => new Model\Response(description: 'Error - the Relation is not of type COMMON or the given version is not a draft.'),
            Response::HTTP_NOT_FOUND => new Model\Response(description: 'Error - content item  or the Relation were not found in the given version.'),
        ],
    ),
)]
