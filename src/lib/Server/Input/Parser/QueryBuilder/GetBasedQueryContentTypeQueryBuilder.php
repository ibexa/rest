...
{
    private const string CONTENT_TYPE_QUERY_MEDIA_TYPE = 'application/vnd.ibexa.api.internal.ContentTypeQuery';

    public function __construct(
        private readonly ParsingDispatcher $parsingDispatcher
    ) {
    }
