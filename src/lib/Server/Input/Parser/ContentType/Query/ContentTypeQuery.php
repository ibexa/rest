...
final class ContentTypeQuery extends BaseParser
{
    ...
    private const string SORT_CLAUSES = 'SortClauses';
    private const string AGGREGATIONS = 'Aggregations';

    public function __construct(
        private readonly CriterionProcessorInterface $criterionProcessor,
        private readonly SortClauseProcessorInterface $sortClauseProcessor
    ) {
    }
