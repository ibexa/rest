...
XML;
        ...
        $this->assertHttpResponseHasHeader($response, 'content-type', 'application/vnd.ibexa.api.ContentInfo+json');
        ...
        return sprintf(
            '%s/%d',
            $contentInfo['Content']['Versions']['_href'],
            $contentInfo['Content']['currentVersionNo']
        );
    }
